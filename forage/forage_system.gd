...
# 스폰 후보 지점 — 밭 Rect2i(4,8,8,4)·침대(5)·상점(-5)·상자(-2,4)·연못(10,0,0) 회피
# (5,0,8)은 밭이 광장 밖으로 옮겨오면서 밭 안이 됐다 → 옛 밭 자리 초지 (6,0,5)로 물렸다.
const SPAWN_POINTS := [
	Vector3(-6, 0, 8), Vector3(-3, 0, 9), Vector3(2, 0, 9), Vector3(6, 0, 5),
