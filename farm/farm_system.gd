...
# 밭 구역: cell x[4..11], z[7..10] = 월드 x[4,12] · z[7,11]. 32칸.
...
# 한 줄 남쪽(z8..11)에 뒀더니 이번엔 플레이어 집 북벽과 0.5밖에 안 떨어져 밭이 벽에 처박혔다 —
# 사람이 지나갈 수 있어야 한다. 지금 자리 이격: 판석 림 8.12 · 건물 벽면 1.54 · 길 2.11 ·
# 강 4.53 · 다리 5.52 (벽면은 모델 미배포 박스 폴백 기준 — 현행 집 GLB는 더 짧아 1.82).
# test_core _test_farm_off_plaza가 흙 노드와 집 노드 좌표를 직접 재서 문다.
const REGION := Rect2i(4, 7, 8, 4)
